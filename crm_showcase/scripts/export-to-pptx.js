...
/**
 * Export CRM Showcase to PowerPoint
 * 
...
const sections = [
  { id: 'hero', name: 'Hero' },
  { id: 'quick-scan', name: 'Quick Scan CRM' },
  { id: 'scoring', name: 'Relationship Scoring' },
  { id: 'segmentation', name: 'Segmentation' },
  { id: 'analytics', name: 'Predictive Analytics' },
  { id: 'profiles', name: 'User Profiles' },
  { id: 'gamification', name: 'Gamification Integration' },
...
async function generatePowerPoint() {
  ...
  const pptxOutput = join(OUTPUT_DIR, 'CRM_Showcase.pptx');
...
async function main() {
  console.log('Starting CRM Showcase export...\n');
  ...
  try {
    ...
    console.log('\n✓ Export complete!');
    console.log(`PowerPoint file: ${join(OUTPUT_DIR, 'CRM_Showcase.pptx')}`);
  } finally {
    await browser.close();
  }
}
