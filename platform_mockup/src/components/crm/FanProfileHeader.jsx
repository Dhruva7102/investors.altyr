...
import { MessageSquare, Gift, Star, Calendar, TrendingUp, Heart } from 'lucide-react'
        ...
        <div className="flex flex-col lg:flex-row lg:items-end gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-white/50">
              <span>LTV: <span className="text-gradient font-medium">{formatCurrency(fan.ltv)}</span></span>
              <span>•</span>
