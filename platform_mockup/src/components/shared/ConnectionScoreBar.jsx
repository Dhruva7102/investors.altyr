...
export default function ConnectionScoreBar({ 
  ...
  const getScoreColor = (score) => {
    if (score >= 80) return 'from-altyr-magenta via-altyr-purple-light to-altyr-purple'
    if (score >= 60) return 'from-altyr-purple-light to-altyr-purple'
    if (score >= 40) return 'from-altyr-orange to-altyr-purple-light'
