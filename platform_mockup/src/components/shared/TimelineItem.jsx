...
import { MessageSquare, DollarSign, ShoppingCart, Star, Award, Heart } from 'lucide-react'
          ...
          <div className="flex items-center gap-2 text-xs text-white/40">
            ...
            {interaction.sentiment && (
              <>
                <span>•</span>
                <span className={
                  interaction.sentiment === 'positive' ? 'text-green-400' :
                  interaction.sentiment === 'negative' ? 'text-red-400' :
                  'text-white/40'
                }>
                  {interaction.sentiment}
                </span>
