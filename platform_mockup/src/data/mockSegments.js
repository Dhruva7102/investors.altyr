...
export const segments = [
  {
    ...
    characteristics: [
      ...
      'Regular custom content purchases',
    ...
    recommendedActions: [
      ...
      'Acknowledge milestones promptly',
      'Request feedback on new content',
    ],
    color: '#FFD700',
  ...
  },
  {
    ...
    characteristics: [
      ...
      'Regular tippers',
      'Moderate engagement',
      'Potential to become whales',
    ],
    recommendedActions: [
      'Nurture with regular communication',
      'Offer VIP upgrade paths',
      'Create exclusive tier benefits',
  ...
  },
  {
    ...
    recommendedActions: [
      ...
      'Use mass messaging efficiently',
      'Focus on conversion to Regular',
