...
import { GlassCard, MetricCard, IconContainer } from '@/components/shared'
import { revenueMetrics, revenueBySegment, revenueConcentration } from '@/data/mockRevenue'
import { offers, getActiveOffers } from '@/data/mockOffers'
            ...
            {segments.map((segment, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-white/50">{segment.count} fans ({segment.percentage}%)</span>
                </div>
