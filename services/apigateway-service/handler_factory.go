...
import (
	...
	"github.com/krakend/krakend-ce/v2/authCustom"
	"github.com/krakend/krakend-ce/v2/authKeyclock"
)
...
func NewHandlerFactory(logger logging.Logger, metricCollector *metrics.Metrics, rejecter jose.RejecterFactory) router.HandlerFactory {
	...
	handlerFactory = authKeyclock.HandlerFactory(handlerFactory, logger)
	handlerFactory = authCustom.HandlerFactory(handlerFactory, logger)
