      ...
      <div className="flex flex-col gap-4">
        {sections.map((section, index) => (
          ...
          >
            ...
            <motion.span
              className="absolute right-8 px-3 py-1 text-xs text-white/80 bg-black/80 backdrop-blur-sm rounded-md border border-white/10 pointer-events-none whitespace-nowrap"
