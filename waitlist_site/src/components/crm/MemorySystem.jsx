      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            {!preferences?.birthday && !preferences?.anniversaryDate && <p className="text-sm text-white/40">No dates recorded</p>}
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <button className="text-xs text-altyr-magenta hover:text-altyr-purple-light transition-colors">Edit</button>
          </div>
