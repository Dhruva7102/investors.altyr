...
export default function SectionLabel({ label, centered = true, animate = true, className = '' }) {
  const content = (
    <div className={`flex items-center gap-6 ${centered ? 'justify-center' : ''} ${className}`}>
      ...
      <span className="text-xs tracking-[0.35em] text-altyr-magenta/80 uppercase font-medium">{label}</span>
