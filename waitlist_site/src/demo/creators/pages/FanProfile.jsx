...
export default function FanProfile() {
  ...
  if (!fan) {
    return (
      <div className="flex flex-col items-center justify-center h-64">
        ...
        <button onClick={() => navigate('/demo/creators/fan-crm')} className="text-altyr-magenta hover:text-altyr-purple-light transition-colors">
          Back to CRM
        </button>
      </div>
    )
  ...
  return (
    <div className="space-y-6">
      <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-sm text-white/50 hover:text-white/80 transition-colors">
